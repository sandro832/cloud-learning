...
#Set-AzContext -SubscriptionId e67a50bc-70b2-4838-8598-c9fb1880a4ac
#Connect-Azaccount

$GroupName = 'Sandro-Taged-Test'
$Location  = 'westeurope'
...
$Resource = Get-AzResource -ResourceGroupName $GroupName
$Resource | ForEach-Object { $_.Tags.Add("VM", "$VmName") }
$Resource | Set-AzResource -Force

#$tags = (Get-AzResource -ResourceGroupName $GroupName -Name $VmName).Tags
"$Username@$MyIP"
$tags
